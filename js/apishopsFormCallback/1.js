...
apishopsFormCallbackText = "<div class='apishopsFormCallbackText'>\n\n<h2 style='margin-top: 0px;'>Понравился этот товар?</h2>\n\nМы расскажем Вам все об этом товаре, предложим наилучшие условия и ознакомим с подходящими акционными предложениями!<br>\n\n<form class=\"apishopsFormCallbackTextOrder\">\n    <input type=\"text\" placeholder=\"Ваш номер телефона\" value=\"\" name=\"apishopsFormPhone\">\n    <input type=\"submit\" value=\"Перезвонить мне!\">\n</form>\n\n<div style='font-weight: bold;'>Оператор перезвонит Вам через 15-30 минут</div>\n\n</div>";
